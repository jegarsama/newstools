  ...
  <tr>
    <td class="border09"><table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" background="<?= BOARDSKINPATH?>/btn_img/bg02.gif">
        <tr>
          ...
          <td style="padding-left:10"><font color="#0781C0"><?=$info[name]?> (<?=$info[rdate]?>)</font></td>
  ...
  <tr>
    <td class="border09"><table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" background="<?= BOARDSKINPATH?>/btn_img/bg02.gif">
        <tr>
          ...
          <td style="padding-left:10"><?=$info[title]?></td>
        </tr>
      </table></td>
  </tr>

  <tr>
    <td style="padding:5"><?=$contents?></td>
  </tr>
...
<?if($_COOKIE["mid"] == $tail_row[uid] ||  auth_chk(3)){ // 로그인아이디와 글쓴이 아이디가 같으면..?>
      <tr>
        <td align="right"><a href="javascript:taildel('<?=$no?>','<?=$tail_row["bno"]?>','<?=$tail_row["no"]?>');">[삭제]</a></td>
      </tr>
<? } ?>
	  <tr>
        <td style="padding:5"><?= $content?></td>
      </tr>
...
//-->
      ...
      <tr>
        <td>
          <textarea name="content" cols="70" rows="3" onkeydown="clrImg(this)" onmousedown="clrImg(this)" style="background-image:url(../images/comment.jpg);background-repeat:no-repeat;background-position:center;"></textarea>
          </td>
        <td>
   			<INPUT type="image" src="<?= BOARDSKINPATH?>/btn_img/btn_icon.gif" width="55" height="51" border="0" >
		</td>
      </tr>
    </table></td>
  </tr>
...
<?}}?>
  ...
  <tr>
    <td style="padding:7 10 0 10"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="right">
          <a href="<?=$post->post_name?>?pagenum=<?=$pagenum?>&ti=<?=$ti?>&co=<?=$co?>&word=<?=$word?>&search=<?=$search?>"><img src="<?= BOARDSKINPATH?>/btn_img/bt_list.gif" width="56" height="23" border="0"></a>
          ...
          <a href="<?=$post->post_name?>?mode=write"><img src="<?= BOARDSKINPATH?>/btn_img/bt_write.gif" width="56" height="23" border="0"></a></td>
          <?}?>
        </tr>
      </table></td>
  </tr>
