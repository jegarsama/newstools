...
?>
			<div id="view">
				...
				<table  border="0" cellspacing="0" cellpadding="0" class="board01_table">
					<tr>
						<td class="pd10 line20px board01_td_al"><?=$gcls_Page->cls_EZ_BBSControl->GetDataByReplace( "ez_bbs", "content", "\n", "<br />" );?></td>
					</tr>
				</table>
				<table width="705" border="0" cellspacing="0" cellpadding="0" class="marT10" id="btnBar">
					<tr>
						<td class="right" >
						<a href="<?=$gcls_Page->GetPageLinkOfList()?>"><img src="http://image.heart-heart.org/btn/www_list.gif" align="absmiddle" alt="글목록" /></a>
						<a href="<?=$gcls_Page->GetPageLinkOfReply();?>"><img src="http://image.heart-heart.org/btn/www_reply.gif" align="absmiddle" alt="댓글" /></a>
						<a href="<?=$gcls_Page->GetPageLinkOfModify();?>"><img src="http://image.heart-heart.org/btn/www_modify.gif" align="absmiddle" alt="수정" /></a>
						<a href="" onClick="javascript:deleteConfirm(); return false;"><img src="http://image.heart-heart.org/btn/www_delete.gif" align="absmiddle" alt="삭제" /></a>
						</td>
					</tr>
				</table>
			</div>
