...
function payMethodUseChk()
{
    ...
    {
alert('debug2');
       var v_frm = document.kcpForm;

        layer_cont_obj   = document.getElementById("web_content");
...
?>
<? include "top.php";?>
<table id="web_content" width="1100" border="0" cellspacing="0" cellpadding="0" bgcolor="<?=$ALL_BGCOLOR?>">
...
<script type="text/javascript" src="/AllplanPG/kcp/mobile/approval_key.js"></script>
		<?
	}
	?>
<?
...
<?
	...
	include "AllplanPG/kcp/payplus/cfg/site_conf_inc.php";       // 환경설정 파일 include
 ?>
<FORM name='kcpForm' action="AllplanPG/kcp/pp_ax_hub.php" method="post">
<input type='hidden' name='site_cd'        value='<?=$site_cd?>'>";
<input type='hidden' name='site_key'       value='<?=$site_key?>'>";
<input type='hidden' name='pay_method'     value='100000000000'>		<!-- <input type="hidden" name='pay_method'   value="CARD"> -->
<input type='hidden' name='tran_cd'        value='00100000'>
<input type='hidden' name='module_type'    value='01'>
<input type='hidden' name='currency'       value='WON'>					<!-- <input type="hidden" name='currency'     value="410"> -->
...
<input type="hidden" name='Ret_URL'      value="http://dodamdodam.com/AllplanPG/kcp/pp_ax_hub_mobile.php">
<!-- 인증시 필요한 파라미터(변경불가)-->
