...
?>
			...
			<div class="marT15" style="padding:0px 10px; width:705px;">
				<!--Movie Comment View Table :STR -->
				<div>
								<div class="marB5 b" ><img src="http://image.heart-heart.org/icon/bullet03.gif">&nbsp;댓글달기</div>
