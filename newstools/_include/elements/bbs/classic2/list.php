...
#region License Statement
	...
	//
	// 파일명	: list.php
	// 경로		: [orchestra]/_include/elements/bbs/classic2/
	// 코드		: ANSI
	// 설명		: BBS(classic2) list 출력
			...
			<div id="view">
					...
					<tr>
						...
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="mar5050">
								<tr>
									...
									<td width="360" align="center"><img src="http://image.heart-heart.org/img/www_board01_th_title.gif" align="absmiddle"></td>
									<td width="120" align="center"><img src="http://image.heart-heart.org/img/www_board01_th_writer.gif" align="absmiddle">&nbsp;</td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><?
					...
					<tr>
						...
						<td width="340" class="board01_td_al"><a href="<?=$gcls_Page->GetPageLinkOfView();?>"><?=$gcls_Page->cls_EZ_BBSControl->GetDataByKStrCut( "ez_bbs", "subject", 200 );?></a></td>
						<td width="110" class="board01_td_ac"><?=$gcls_Page->cls_EZ_BBSControl->GetData( "ez_bbs", "name" )?></td>
					...
					while( $gcls_Page->LoopForBBS( $lrs_loop ) )
					{
						$subject = $gcls_Page->cls_EZ_BBSControl->GetDataByKStrCut( "ez_bbs", "subject", 200 );
						$subject = $subject.($gcls_Page->IsPrivacyOfBBS() ? "&nbsp;<img src='http://image.heart-heart.org/icon/lock.gif' />" : "");
						$re_space = ""; for($ii=0; $ii < $gcls_Page->cls_EZ_BBSControl->GetData( "ez_bbs", "depno" ); $ii++) $re_space.= "&nbsp;&nbsp;";					// respace
						$re_space = ((0 < $gcls_Page->cls_EZ_BBSControl->GetData( "ez_bbs", "depno" )) ? "<img src=\"http://image.heart-heart.org/icon/re.gif\" />" : "").$re_space;
					?>
					<tr>
						<td width="65" class="board01_td_ac"><?=$no?></td>
						<td width="340" class="board01_td_al"><?=$re_space?><a href="<?=$gcls_Page->GetPageLinkOfView();?>"><?=$subject?></a></td>
						<td width="110" class="board01_td_ac"><?=$gcls_Page->cls_EZ_BBSControl->GetData( "ez_bbs", "name" )?></td>
						<td width="85" class="board01_td_ac"><?=$gcls_Page->cls_EZ_BBSControl->GetDataByFormattedDayTime( "ez_bbs", "wdate", "Y. m. d" )?></td>
						<td width="55" class="board01_td_ac"><?=$gcls_Page->cls_EZ_BBSControl->GetDataByFormattedNumber( "ez_bbs", "count", 0 )?></td>
					</tr><?
				...
				<table width="705" border="0" cellspacing="0" cellpadding="0" class="marT10" id="">
					<tr>
						...
						<td width="260" class="right">
							<a href="<?=$gcls_Page->GetPageLinkOfList()?>"><img src="http://image.heart-heart.org/btn/www_list.gif" align="absmiddle" alt="목록보기" /></a>
							<a href="<?=$gcls_Page->GetPageLinkOfWrite();?>"><img src="http://image.heart-heart.org/btn/www_write.gif" align="absmiddle" alt="글쓰기" /></a>
						</td>
					</tr>
				</table>
				</form>
