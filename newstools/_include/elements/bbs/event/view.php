...
?>
			<div id="view">
				...
				<table width="705" border="0" cellspacing="0" cellpadding="0" class="marT10" id="btnBar">
					<tr>
						<td class="right" ><a href="<?=$gcls_Page->GetPageLinkOfList()?>&amp;status=<?=$ls_Status?>"><img src="http://image.heart-heart.org/btn/www_list.gif" align="absmiddle" alt="글목록" /></a></td>
					</tr>
				</table>
			</div>